...
public class Validate_WhenThereIsNoItemInfo_ShouldReturnNoItemInfoOnPageError : Context
{
    public Validate_WhenThereIsNoItemInfo_ShouldReturnNoItemInfoOnPageError()
    {
