...
<b>{4}</b> - если у вас есть какой-то вопрос, пожелание или негодование, обращайтесь в поддержку.");
        ...
        resources.AddResource(
            ...
            "🚀 Вам потрібно всього лише надіслати посилання на бажаний товар та очікувати знижку!",
            "🚀 Вам нужно всего лишь отправить ссылку на желаемый товар и ожидать скидку!");
...
ℹ️ Сейчас установлено <b>{0}</b>%.");
        ...
        resources.AddResource(ResourceKey.Dialog_AddExample, "Додати приклад ➕", "Добавить пример ➕");
        
        resources.AddResource(
            ResourceKey.Dialog_ExampleAdded,
            "Приклад додано! ✅",
            "Пример добавлен! ✅");
    }
}